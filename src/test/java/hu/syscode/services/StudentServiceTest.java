...
class StudentServiceTest {
	...
	void testUpdateStudent() {
		...
		Optional<Student> emptyStudent = studentService.updateStudent(UUID.randomUUID(), "Teszt István",
				"tesztistvan@email.hu");
		...
		Optional<Student> updatedStudent = studentService.updateStudent(UUID.randomUUID(), "Teszt István",
				"tesztistvan@email.hu");
